...
export class vocationUpdate1643965172627 implements MigrationInterface {
    name = 'vocationUpdate1643965172627'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`vocation\` ADD CONSTRAINT \`FK_cf2726e85fe94b72ddf75be305f\` FOREIGN KEY (\`id_ultimate\`) REFERENCES \`ultimate\`(\`id_ultimate\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`vocation\` ADD CONSTRAINT \`FK_bb3c94df0e4f4f3bdce6329dc3b\` FOREIGN KEY (\`id_vocation_appearance\`) REFERENCES \`vocation_appearance\`(\`id_vocation_appearance\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`ultimate\` ADD CONSTRAINT \`FK_d9c535f6fb439b973fe2d9a7d04\` FOREIGN KEY (\`id_game_animation\`) REFERENCES \`game_animation\`(\`id_game_animation\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
