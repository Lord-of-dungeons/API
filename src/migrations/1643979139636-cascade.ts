...
export class cascade1643979139636 implements MigrationInterface {
    name = 'cascade1643979139636'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`ultimate\` ADD CONSTRAINT \`FK_d9c535f6fb439b973fe2d9a7d04\` FOREIGN KEY (\`id_game_animation\`) REFERENCES \`game_animation\`(\`id_game_animation\`) ON DELETE SET NULL ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE \`vocation\` ADD CONSTRAINT \`FK_bb3c94df0e4f4f3bdce6329dc3b\` FOREIGN KEY (\`id_vocation_appearance\`) REFERENCES \`vocation_appearance\`(\`id_vocation_appearance\`) ON DELETE NO ACTION ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`vocation\` ADD CONSTRAINT \`FK_cf2726e85fe94b72ddf75be305f\` FOREIGN KEY (\`id_ultimate\`) REFERENCES \`ultimate\`(\`id_ultimate\`) ON DELETE SET NULL ON UPDATE RESTRICT`);
        await queryRunner.query(`ALTER TABLE \`vocation\` ADD CONSTRAINT \`FK_bb3c94df0e4f4f3bdce6329dc3b\` FOREIGN KEY (\`id_vocation_appearance\`) REFERENCES \`vocation_appearance\`(\`id_vocation_appearance\`) ON DELETE NO ACTION ON UPDATE RESTRICT`);
        ...
        await queryRunner.query(`ALTER TABLE \`vocation_appearance\` ADD CONSTRAINT \`FK_387d9274894f4c6d235f534dc8f\` FOREIGN KEY (\`id_game_animation\`) REFERENCES \`game_animation\`(\`id_game_animation\`) ON DELETE SET NULL ON UPDATE RESTRICT`);
        await queryRunner.query(`ALTER TABLE \`ultimate\` ADD CONSTRAINT \`FK_d9c535f6fb439b973fe2d9a7d04\` FOREIGN KEY (\`id_game_animation\`) REFERENCES \`game_animation\`(\`id_game_animation\`) ON DELETE SET NULL ON UPDATE RESTRICT`);
    }
